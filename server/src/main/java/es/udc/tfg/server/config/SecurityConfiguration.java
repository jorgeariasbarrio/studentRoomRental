...
import es.udc.tfg.server.security.JWTConfigurer;
import es.udc.tfg.server.security.MyUnauthorizedEntryPoint;
import es.udc.tfg.server.security.MyUserDetailsService;
...
import es.udc.tfg.server.security.MyAccessDeniedHandler;
