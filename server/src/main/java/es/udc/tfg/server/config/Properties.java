...
public class Properties {
  ...
  public String getImagenCopyPath() {
    return imagenCopyPath;
  }

  public void setImagenCopyPath(String imagenCopyPath) {
    this.imagenCopyPath = imagenCopyPath;
  }
}
